...
$correspondances = array(
    ...
    "Jean-Luc Mélenchon"    =>["LFI",   1],
    "Emmanuel Macron"=>["LREM",  1],
    "Xavier Bertrand"=>["LR",    0],
    "Michel Barnier"=>["LR",    0],
    "Jean Lassalle"=>["",      1],
    "Florian Philippot"=>["LP",    1],
    "François Asselineau"=>["UPR",   1],
    "Jean-Christophe Lagarde"=>["UDI",   0],
    "Jean-Frédéric Poisson"=>["PCD",   1],
    "Sandrine Rousseau"=>["EELV",  -1],
    "Laurent Wauquiez"=>["LR",    0],
    "François Baroin"=>["LR",    -1],
    "Rachida Dati"=>["LR",    -1],
    "Olivier Faure"=>["PS",    -1],
    "Ségolène Royal"=>["PS",    -1],
    "Bruno Retailleau"=>["LR",    -1],
    "François Hollande"=>["PS",    -1],
    "Eric Piolle"=>["EELV",  -1],
    "Eric Ciotti"=>["LR",    0],
    "Philippe Juvin"=>["LR",    0],
    "Denis Payre"=>["LR",    -1],
    "Jacques Cheminade"=>["SP",    1],
    "Hélène Thouy"=>["PA",    1]
